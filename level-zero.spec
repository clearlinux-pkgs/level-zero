...
Version  : 1.8.1
Release  : 3
URL      : https://github.com/oneapi-src/level-zero/archive/v1.8.1/level-zero-1.8.1.tar.gz
Source0  : https://github.com/oneapi-src/level-zero/archive/v1.8.1/level-zero-1.8.1.tar.gz
Summary  : Level Zero
...
%prep
%setup -q -n level-zero-1.8.1
cd %{_builddir}/level-zero-1.8.1
...
cp %{_builddir}/level-zero-1.8.1/LICENSE %{buildroot}/usr/share/package-licenses/level-zero/6ec9ed37578702833be1af0c8089e57132b8a6bf
pushd clr-build
%make_install
popd
