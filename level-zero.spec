...
Source0  : https://github.com/oneapi-src/level-zero/archive/v1.8.5/level-zero-1.8.5.tar.gz
Summary  : Level Zero
...
%prep
%setup -q -n level-zero-1.8.5
cd %{_builddir}/level-zero-1.8.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1658762894
mkdir -p clr-build
pushd clr-build
