...
Source0  : https://github.com/oneapi-src/level-zero/archive/v1.16.15/level-zero-1.16.15.tar.gz
...
%prep
%setup -q -n level-zero-1.16.15
cd %{_builddir}
tar xf %{_sourcedir}/v1.13.0.tar.gz
cd %{_builddir}/level-zero-1.16.15
mkdir -p source/utils/spdlog
cp -r %{_builddir}/spdlog-1.13.0/* %{_builddir}/level-zero-1.16.15/source/utils/spdlog
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1714671583
mkdir -p clr-build
pushd clr-build
