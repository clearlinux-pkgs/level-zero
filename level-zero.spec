...
Source0  : https://github.com/oneapi-src/level-zero/archive/v1.15.1/level-zero-1.15.1.tar.gz
Summary  : Level Zero
...
%prep
%setup -q -n level-zero-1.15.1
cd %{_builddir}/level-zero-1.15.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698243389
mkdir -p clr-build
pushd clr-build
