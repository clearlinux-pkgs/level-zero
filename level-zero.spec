...
Source0  : https://github.com/oneapi-src/level-zero/archive/v1.8.8/level-zero-1.8.8.tar.gz
Summary  : Level Zero
...
%prep
%setup -q -n level-zero-1.8.8
cd %{_builddir}/level-zero-1.8.8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665413946
mkdir -p clr-build
pushd clr-build
