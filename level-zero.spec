...
Source0  : https://github.com/oneapi-src/level-zero/archive/v1.17.28/level-zero-1.17.28.tar.gz
...
%prep
%setup -q -n level-zero-1.17.28
cd %{_builddir}
tar xf %{_sourcedir}/v1.13.0.tar.gz
cd %{_builddir}/level-zero-1.17.28
mkdir -p source/utils/spdlog
cp -r %{_builddir}/spdlog-1.13.0/* %{_builddir}/level-zero-1.17.28/source/utils/spdlog
pushd ..
cp -a level-zero-1.17.28 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1723593291
mkdir -p clr-build
pushd clr-build
