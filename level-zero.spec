...
Source0  : https://github.com/oneapi-src/level-zero/archive/v1.17.17/level-zero-1.17.17.tar.gz
...
%prep
%setup -q -n level-zero-1.17.17
cd %{_builddir}
tar xf %{_sourcedir}/v1.13.0.tar.gz
cd %{_builddir}/level-zero-1.17.17
mkdir -p source/utils/spdlog
cp -r %{_builddir}/spdlog-1.13.0/* %{_builddir}/level-zero-1.17.17/source/utils/spdlog
pushd ..
cp -a level-zero-1.17.17 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720048199
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libze_loader.so.1.17.0
/V3/usr/lib64/libze_tracing_layer.so.1.17.0
/V3/usr/lib64/libze_validation_layer.so.1.17.0
/usr/lib64/libze_loader.so.1
/usr/lib64/libze_loader.so.1.17.0
/usr/lib64/libze_tracing_layer.so.1
/usr/lib64/libze_tracing_layer.so.1.17.0
/usr/lib64/libze_validation_layer.so.1
/usr/lib64/libze_validation_layer.so.1.17.0
