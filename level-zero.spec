...
Source0  : https://github.com/oneapi-src/level-zero/archive/v1.9.4/level-zero-1.9.4.tar.gz
Summary  : Level Zero
...
%prep
%setup -q -n level-zero-1.9.4
cd %{_builddir}/level-zero-1.9.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674227549
mkdir -p clr-build
pushd clr-build
