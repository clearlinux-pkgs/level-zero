...
Source0  : https://github.com/oneapi-src/level-zero/archive/v1.21.9/level-zero-1.21.9.tar.gz
...
%prep
%setup -q -n level-zero-1.21.9
cd %{_builddir}
tar xf %{_sourcedir}/v1.13.0.tar.gz
cd %{_builddir}/level-zero-1.21.9
mkdir -p source/utils/spdlog
cp -r %{_builddir}/spdlog-1.13.0/. %{_builddir}/level-zero-1.21.9/source/utils/spdlog
pushd ..
cp -a level-zero-1.21.9 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745274147
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/level-zero-%{version}/LICENSES/MIT.txt %{buildroot}/usr/share/package-licenses/level-zero/36a256f2345d0fb78f2472caae6ae46c5a32cafa || :
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libze_loader.so.1.21.9
/V3/usr/lib64/libze_tracing_layer.so.1.21.9
/V3/usr/lib64/libze_validation_layer.so.1.21.9
/usr/lib64/libze_loader.so.1
/usr/lib64/libze_loader.so.1.21.9
/usr/lib64/libze_tracing_layer.so.1
/usr/lib64/libze_tracing_layer.so.1.21.9
/usr/lib64/libze_validation_layer.so.1
/usr/lib64/libze_validation_layer.so.1.21.9

%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/level-zero/36a256f2345d0fb78f2472caae6ae46c5a32cafa
