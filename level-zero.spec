...
Source0  : https://github.com/oneapi-src/level-zero/archive/v1.8.12/level-zero-1.8.12.tar.gz
Summary  : Level Zero
...
%prep
%setup -q -n level-zero-1.8.12
cd %{_builddir}/level-zero-1.8.12
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670889548
mkdir -p clr-build
pushd clr-build
