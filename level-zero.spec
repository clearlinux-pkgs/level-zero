...
Version  : 1.8
Release  : 2
URL      : https://github.com/oneapi-src/level-zero/archive/v1.8/level-zero-1.8.tar.gz
Source0  : https://github.com/oneapi-src/level-zero/archive/v1.8/level-zero-1.8.tar.gz
Summary  : Level Zero
...
%prep
%setup -q -n level-zero-1.8
cd %{_builddir}/level-zero-1.8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1652680387
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/level-zero-1.8/LICENSE %{buildroot}/usr/share/package-licenses/level-zero/6ec9ed37578702833be1af0c8089e57132b8a6bf
pushd clr-build
%make_install
popd
...
/usr/lib64/libze_loader.so.1.8.0
/usr/lib64/libze_tracing_layer.so.1
/usr/lib64/libze_tracing_layer.so.1.8.0
/usr/lib64/libze_validation_layer.so.1
/usr/lib64/libze_validation_layer.so.1.8.0
